...
def cli_main():
    ...
    train_transform = PretrainTransform(image_size=args.image_size, crop_scale=crop_scale, view=(1 if args.model=='supervised' else 2), use_mask=('mask' in args.dataset))
